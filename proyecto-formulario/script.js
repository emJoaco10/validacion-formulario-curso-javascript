...
document.getElementById('formulario').addEventListener('submit', submitFunction) //Escucha el submit
...
camposTexto.forEach(campo => {
    ...
    if (edad.value < 18) {
        mostrarError(errorEdad, '¡Para registrarse hay que ser mayor de edad!')
        validacionCorrecta = false
    } else {
    ...
    if (nivelEstudio.value == '') {
        mostrarError(errorActividad, '¡Seleccione un nivel de estudio!')
        validacionCorrecta = false
    } else {
